...
std::shared_ptr<Camera> Assignment5::CreateCamera() const
{
    ...
    camera->SetPosition(glm::vec3(0.f, -24.1469f, 2.73693f));
...
std::shared_ptr<Scene> Assignment5::CreateScene() const
{
    ...
    pointLight->SetPosition(glm::vec3(0.01909f, -1.0101f, 1.97028f));
    pointLight->SetLightColor(glm::vec3(1.f, 1.f, 0.f));
